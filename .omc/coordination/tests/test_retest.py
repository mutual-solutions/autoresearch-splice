...
VERIFY_AGENT_PATH = REPO_ROOT / ".omc" / "coordination" / "verify_agent.py"
...
def test_dry_run_no_mutation(tmp_path, monkeypatch):
    ...
    mod.BASELINE_PATH = repo / ".omc" / "coordination" / "baseline_metrics.json"
...
def test_keep_path_verb_byte_identical_commit_message(tmp_path):
    ...
    #   - .omc/coordination/baseline_metrics.json
    ...
    (repo / ".omc" / "coordination").mkdir()
    (repo / ".omc" / "coordination" / "baseline_metrics.json").write_text(
